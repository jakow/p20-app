...
type TicketStartProps = {
  ...
  onNoTicketButtonClick: () => void,
}

export default class TicketStart extends React.Component<void, TicketStartProps, void> {
  componentDidMount() {
          ...
          <View style={style.container}>
            ...
            <View style={style.buttons}>
              <Button
                primary
                style={style.button}
                onPress={this.props.onTicketButtonClick}
              >
              ...
              <Button
                ...
                primary
                style={style.button}
                onPress={this.props.onNoTicketButtonClick}
              >
